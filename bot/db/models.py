from sqlalchemy import BigInteger, Integer, Text, String, Date, Boolean, SmallInteger
...
class Like(Base):
    __tablename__ = 'likes'
    id: Mapped[int] = mapped_column(Integer, primary_key=True, autoincrement=True)
    sender: Mapped[int] = mapped_column(BigInteger, nullable=False)
    recipient: Mapped[int] = mapped_column(BigInteger, nullable=False)
